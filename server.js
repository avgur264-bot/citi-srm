...
- ПЛОЩАДЬ (area): указывай ТОЛЬКО если прямо внутри этого помещения на плане напечатано число площади в м² (например «12,5» или «12.5 м²»). Если числа не видно, ты не уверен, или пришлось бы оценивать по размеру/масштабу — ставь null. КАТЕГОРИЧЕСКИ НЕ выдумывай площадь, НЕ оценивай «на глаз» и НЕ повторяй одно и то же число у разных помещений — если сомневаешься, всегда null;
