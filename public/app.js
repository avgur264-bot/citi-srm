...
/* ============================================================
   ...
   ============================================================ */
(async function boot(){
  try{ const c = await api('/api/config'); ALLOW_REG = !!c.allowRegistration; }catch{ ALLOW_REG=false; }
  try{
...
const PAGE_HELP={
  ...
  upkeep:{t:'Плановое ТО',d:'Реестр оборудования (лифты, вентиляция, пожарная сигнализация и др.) с графиком обслуживания. Система показывает, что просрочено или скоро требует ТО; кнопка «Отметить ТО» планирует следующее обслуживание.'},
...
async function afterStateChange(){ recordAudit(); await saveState(); render(); }
