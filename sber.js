...
// поступлений с начислениями аренды. ТОЛЬКО ЧТЕНИЕ.
//
// SCOPE (ровно этот, ничего лишнего — ни карт, ни платежей, ни авансов):
//   openid GET_CLIENT_ACCOUNTS GET_STATEMENT_ACCOUNT GET_STATEMENT_TRANSACTION
// Указывается клиентом при формировании ссылки авторизации (/v2/oauth/authorize)
// и при создании сервиса в личном кабинете Sber API.
//
